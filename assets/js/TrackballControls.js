...
THREE.TrackballControls = function (object, domElement) {
  ...
  this.getMouseOnScreen = (clientX, clientY) => {
  ...
  this.getMouseProjectionOnBall = (clientX, clientY) => {
  ...
  this.domElement.addEventListener("mousewheel", mousewheel, {
    passive: false,
  });
  this.domElement.addEventListener("DOMMouseScroll", mousewheel, {
    passive: false,
  }); // firefox
