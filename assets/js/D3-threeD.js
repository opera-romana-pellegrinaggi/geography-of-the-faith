...
function d3threeD(exports,d3) {
  ...
  let applySVGTransform = (obj, tstr) => {
    let idx = tstr.indexOf("("),
      len = tstr.length,
  ...
  let wrap_setAttribute = (name, value) => {}
  let wrap_setAttributeNS = (namespace, name, value) => {}
  ...
  class commonSetAttribute {
        constructor(name, value) {
            switch (name) {
                ...
                case "d":
                    let shape = transformSVGPath(value),
  ...
  let commonSetAttributeNS = (namespace, name, value) => {
  ...
  class Mesh {
        constructor(parentThing, tag, geometry, material) {
  ...
  */
    ...
    let backlight = new THREE.SpotLight(0x888888);
  ...
  */
    ...
    function helperPlanes(maxBound) {
      let geom = new THREE.PlaneGeometry(maxBound, maxBound, 4, 4);
      for (let i = 0; i < 4; i++) {
        let color, cx, cy;
        switch (i) {
          case 0:
